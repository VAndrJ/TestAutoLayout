...
public extension UIView {
    ...
    @inline(__always) @inlinable func addSubviewsArray(_ subviews: [UIView]) {
        subviews.forEach(addSubview)
    }
...
extension UIStackView {
    ...
    @inline(__always) @inlinable func addArrangedSubviews(_ subviews: UIView...) {
        addArrangedSubviewsArray(subviews)
    }

    @inlinable func addArrangedSubviewsArray(_ subviews: [UIView]) {
